    ...
    <div className="container-site py-10">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="w-full lg:w-1/4 space-y-5">
          ...
          {/* Main Filter Title (matching screenshot styling) */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative aspect-square bg-[#f8f9fa] rounded-card overflow-hidden flex items-center justify-center select-none group-hover:scale-102 transition-transform duration-280">
                        ...
                        {product.discount > 0 && (
                          <span className="absolute top-2 left-2 bg-primary text-white text-[9px] font-bold px-1.5 py-0.5 rounded-sm">
                            -{product.discount}%
                          </span>
                        )}
                        {product.hot && (
                          <span className="absolute top-2 left-2 bg-accent text-white text-[9px] font-bold px-1.5 py-0.5 rounded-sm">
                            HOT
                          </span>
                        )}
                      </div>
